...
/**
 * Kotlin version of {@link QueryActivity].
 */
    ...
    private fun basicListen() {
        ...
        messagesListener = object : ValueEventListener {
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                // data at this path or a subpart.
                ...
                dataSnapshot.children.forEach { child ->
                    ...
                    // Use the message
                    // [START_EXCLUDE]
                    Log.d(TAG, "message text: ${message?.data}")
                    Log.d(TAG, "message sender name: ${message?.data}")
                    // [END_EXCLUDE]
                }
            }
